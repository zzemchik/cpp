...
void Form::checkBureaucratCan(const Bureaucrat & b) const 
{

	if (b.getGrade() < this->getGradeDo())
		throw GradeTooLowException();
	if (this->getSign() == false)
		throw FormFlaseException();
}
...
Form::FormFlaseException::FormFlaseException() {};
...
const char* Form::FormFlaseException::what() const throw () { return "form false exception"; }
